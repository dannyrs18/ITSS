...
urlpatterns += [
    ...
    url(r'^proceso_entidad/(?P<slug>[-\w]+)/$', views.proceso_entidad, name='proceso_entidad'),
]
...
urlpatterns += [
    ...
    url(r'^tabla_entidad_proceso/$', views.tabla_entidad_proceso, name='tabla_entidad_proceso'),
]
# Otros
urlpatterns += [
