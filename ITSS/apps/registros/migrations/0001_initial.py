...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('admin_vinc', 'Administrador de Vinculacion'), ('admin_prac', 'Administrador de Practicas'), ('resp_vinc', 'Responsable de Vinculacion'), ('resp_prac', 'Responsable de Practicas')),
            },
        ),
    ]
